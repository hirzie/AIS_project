...
<div id="app" class="flex-1 flex flex-col h-full overflow-hidden">
    <nav class="bg-white border-b border-slate-200 h-16 flex items-center justify-between px-6 z-20 shadow-sm">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h1 class="text-xl font-bold text-slate-800 leading-none">List Ruangan/Bangunan</h1>
                <span class="text-xs text-slate-500 font-medium">Pengaturan Kebersihan</span>
            </div>
        </div>
    </nav>
    <main class="flex-1 overflow-y-auto p-6 bg-slate-50">
        <div class="max-w-6xl mx-auto">
            <div class="bg-white rounded-2xl p-12 text-center border-2 border-dashed border-slate-200">
                <i class="fas fa-building text-6xl text-slate-200 mb-4"></i>
                <h3 class="text-xl font-bold text-slate-700">Halaman List Ruangan Sedang Dikembangkan</h3>
                <p class="text-sm text-slate-500 mt-2">Silakan lanjutkan pengaturan di sesi berikutnya.</p>
            </div>
        </div>
    </main>
</div>
